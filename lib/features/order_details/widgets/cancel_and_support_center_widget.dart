...
import 'package:fresh4you/features/order/domain/models/order_model.dart';
import 'package:fresh4you/features/order_details/widgets/cancel_order_dialog_widget.dart';
...
import 'package:fresh4you/features/tracking/screens/tracking_result_screen.dart';
          ...
          (orderModel != null &&
              ...
              : (orderModel != null &&
                  ...
                  ? CustomButton(
                      ...
                      onTap: () => Provider.of<ReOrderController>(context, listen: false)
