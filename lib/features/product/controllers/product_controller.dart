...
import 'package:fresh4you/features/category/domain/models/find_what_you_need.dart';
import 'package:fresh4you/features/product/domain/models/home_category_product_model.dart';
import 'package:fresh4you/features/product/domain/models/most_demanded_product_model.dart';
...
class ProductController extends ChangeNotifier {
  ...
  Future<void> getHomeCategoryProductList(bool reload) async {
    ...
    if (localData != null) {
      ...
      homeCategoryProductList.forEach((homeCategory) => _homeCategoryProductList
