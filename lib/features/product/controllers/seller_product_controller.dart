...
import 'package:fresh4you/features/shop/domain/models/shop_again_from_recent_store_model.dart';
...
class SellerProductController extends ChangeNotifier {
  ...
  Future<void> getShopAgainFromRecentStore() async {
    var localData = await database
        .getCacheResponseById(AppConstants.shopAgainFromRecentStore);

    if (localData != null) {
      var shopAgainFromRecentStoreList = jsonDecode(localData.response);

      shopAgainFromRecentStoreList.forEach((store) =>
