...
import 'package:fresh4you/features/search_product/domain/models/author_model.dart';
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                Autocomplete<int>(
                                  optionsBuilder: (TextEditingValue value) {
                                    if (value.text.isEmpty) {
                                      ...
                                      return authors.where((author) => widget
                                  ...
                                  displayStringForOption: (value) =>
                                      widget.authorList![value].name!,
                                  onSelected: (int value) {
                                    searchProvider.checkedToggleAuthors(
                                        value, widget.fromShop);
                                  },
                                ),
                                if (widget.authorList != null &&
                                    widget.authorList!.isNotEmpty)
                                  ConstrainedBox(
                                    constraints: const BoxConstraints(
                                      minHeight: 40.0,
                                      maxHeight: 350.0,
                              ...
                              //Publishing House
                              if ((widget.publishingHouse != null &&
                                      widget.publishingHouse!.isNotEmpty) &&
                                  (searchProvider.productTypeIndex == 0 ||
                                      searchProvider.productTypeIndex ==
                                          2)) ...[
                                const SizedBox(
                                ...
                                Autocomplete<int>(
                                  optionsBuilder: (TextEditingValue value) {
                                    if (value.text.isEmpty) {
                                      ...
                                      return publishingHouses.where((author) =>
                                          widget.publishingHouse![author].name!
                                              .toLowerCase()
                                              .contains(
                                  ...
                                  displayStringForOption: (value) =>
                                      widget.publishingHouse![value].name!,
                                  onSelected: (int value) {
