...
import 'package:fresh4you/features/shop/domain/models/more_store_model.dart';
import 'package:fresh4you/features/shop/domain/models/seller_info_model.dart';
import 'package:fresh4you/features/shop/domain/models/seller_model.dart';
...
class ShopController extends ChangeNotifier {
  ...
  Future<void> getAllSellerList(bool reload, int offset,
    ...
    ApiResponse apiResponse =
        await shopServiceInterface!.getSellerList('all', offset);
    if (apiResponse.response != null &&
        apiResponse.response!.statusCode == 200) {
      if (offset == 1) {
        allSellerModel = null;
