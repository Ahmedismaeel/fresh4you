...
import 'package:fresh4you/features/offline_payment/domain/models/offline_payment_model.dart';
...
import 'package:fresh4you/features/checkout/screens/digital_payment_order_place_screen.dart';
...
class CheckoutController with ChangeNotifier {
  ...
  String get deliveryDate => _deliveryDate ?? "No Delivery Date yet";
  int? _addressIndex;
  ...
  Future<ApiResponse> getDeliveryDate() async {
    ApiResponse apiResponse = await checkoutServiceInterface.getDeliveryDate();
    if (apiResponse.response != null &&
        apiResponse.response!.statusCode == 200) {
      _deliveryDate = apiResponse.response?.data['delivery_date'];
    } else {
      ApiChecker.checkApi(apiResponse);
    }
    notifyListeners();
  ...
  void setSameAsBilling() {
    sameAsBilling = true; //!sameAsBilling;
    notifyListeners();
  }
