...
import 'package:fresh4you/features/checkout/widgets/custom_check_box_widget.dart';
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  _isPaymentMethodsAvailable(context, checkoutProvider)
                      ? Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisSize: MainAxisSize.min,
                          children: [
                                ...
                                if (Provider.of<SplashController>(context,
                                  ...
                                  Expanded(
                                      child: CustomButton(
                                          isBorder: true,
                                          leftIcon: Images.cod,
                                          backgroundColor: checkoutProvider
                                                  .codChecked
                                  ...
                                  Expanded(
                                      child: CustomButton(
                                          ...
                                          backgroundColor: checkoutProvider
                                              ...
                                              : Theme.of(context).cardColor,
                                          textColor:
                                              checkoutProvider.walletChecked
                                                  ? Colors.white
                                                  : Theme.of(context)
                                                      .textTheme
                                                      .bodyLarge
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      ...
                                                                      borderRadius:
                                                                          BorderRadius.circular(Dimensions
                                                                              .paddingSizeExtraSmall),
                                                                      border: checkoutProvider.offlineMethodSelectedIndex ==
                                                                              index
                                                                          ? Border.all(
                                                                              color: Theme.of(context)
                                                                                  .primaryColor,
                                                                  ...
                                                                  child: Padding(
                                                                    padding: const EdgeInsets
                                                                        ...
                                                                        horizontal:
                                                                            Dimensions.paddingSizeDefault),
                                                                    child: Center(
                                                                        child: Text(checkoutProvider.offlinePaymentModel!.offlineMethods![index].methodName ??
                                                                            '')),
                                                                  )),
                                                            ));
                                                      })))
...
bool _isPaymentMethodsAvailable(
    BuildContext context, CheckoutController checkoutProvider) {
  ...
  bool isOfflinePaymentMethodsOn =
      checkoutProvider.offlinePaymentModel?.offlineMethods != null &&
          checkoutProvider.offlinePaymentModel?.offlineMethods?.isNotEmpty ==true;
