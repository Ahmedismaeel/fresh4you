...
import 'package:fresh4you/features/wishlist/domain/models/wishlist_model.dart';
...
import 'package:fresh4you/features/wishlist/widgets/remove_from_wishlist_bottom_sheet_widget.dart';
            ...
            children: [
              Stack(children: [
                ...
                ((wishlistModel?.productFullInfo!.discount != null) ||
                        (wishlistModel?.productFullInfo!.clearanceSale != null))
                    ? Positioned(
                      ...
                      Flexible(
                        ...
                        child: Text(
                          PriceConverter.convertPrice(
                            context,
                            wishlistModel!.productFullInfo!.unitPrice,
                            discountType: (wishlistModel!.productFullInfo!
                                            .clearanceSale?.discountAmount ??
                                        0) >
                                    0
                                ? wishlistModel!.productFullInfo!.clearanceSale
                            ...
                            discount: (wishlistModel!.productFullInfo!
                                            .clearanceSale?.discountAmount ??
                                        0) >
                                    0
                                ? wishlistModel!.productFullInfo!.clearanceSale
